...
export class Orientation {
    static get buttons() {
        return document.getElementsByClassName('rdnt__orientation');
    }
    static get current() {
        return document.getElementsByClassName('rdnt__current-selection--orientation')[0];
    }
    static get title() {
        return document.getElementsByClassName('rdnt__orientation-settings--title')[0];
    }
