...
export class Annotations {
    ...
    static get annotationSettings() {
        return document.getElementsByClassName('rdnt__annotation-settings')[0];
    }
    static get markerSettings() {
        return document.getElementsByClassName('rdnt__marker-settings')[0];
    }
    static get markerColorSettings() {
        return document.getElementsByClassName('rdnt__marker-color-settings')[0];
    }
    static get annotationLeftContainer() {
        return document.getElementsByClassName('rdnt__annotations-surface--left')[0];
    }
    static get annotationLeftCanvas() {
        return document.getElementsByClassName('rdnt__markings--left')[0];
    }
    static get annotationLeftContext() {
        return this.annotationLeftCanvas.getContext('2d');
    }
    static get annotationLeftComments() {
        return document.getElementsByClassName('rdnt__comments--left')[0];
    }
    static get annotationRightContainer() {
        return document.getElementsByClassName('rdnt__annotations-surface--right')[0];
    }
    static get annotationRightCanvas() {
        return document.getElementsByClassName('rdnt__markings--right')[0];
    }
    static get annotationRightContext() {
        return this.annotationRightCanvas.getContext('2d');
    }
    static get annotationRightComments() {
        return document.getElementsByClassName('rdnt__comments--right')[0];
    }
    static get current() {
        return document.getElementsByClassName('rdnt__current-selection--annotations')[0];
    }
    static get off() {
    ...
    static get button() {
        return document.getElementsByClassName('rdnt__annotations-button')[0];
    }
    static get closeButton() {
        return document.getElementsByClassName('rdnt__close-annotations')[0];
    }
    static get showButton() {
        return document.getElementsByClassName('rdnt__show-annotations')[0];
    }
    static get markerButton() {
        return document.getElementsByClassName('rdnt__marker')[0];
    }
    static get commentButton() {
        return document.getElementsByClassName('rdnt__comment')[0];
    }
    static get commentsList() {
        return document.getElementsByClassName('rdnt__comments-list')[0];
    }
    static get undoButton() {
        return document.getElementsByClassName('rdnt__undo')[0];
    }
    static get markerSizeRange() {
        return document.getElementsByClassName('rdnt__marker-size')[0];
    }
    static get markerColorButtons() {
        return document.getElementsByClassName('rdnt__marker-color');
    }
    static get markingsList() {
        return document.getElementsByClassName('rdnt__markings-list')[0];
    }
    static get eraserButton() {
        return document.getElementsByClassName('rdnt__eraser')[0];
    }
