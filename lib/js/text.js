...
Text.current = document.getElementsByClassName('rdnt__current-selection--translation')[0];
Text.translateButton = document.getElementsByClassName('rdnt__translate')[0];
Text.translateList = document.getElementsByClassName('rdnt__translation-list')[0];
Text.cache = new Map();
Text.language = 'en-GB';
Text.languages = {};
