import { ClientActionType } from '../../../backend/src/api/communication/Actions.js';
import { IssueType } from '../../../backend/src/db/models/types/IssueType.js';
...
Issues.buttons = document.getElementsByClassName('rdnt__issue');
