...
export class Issues {
    ...
    static get audio() {
        return Readiant.getInstance(Readiant.root)?.issuesState.audio ?? new Set();
    }
    static get content() {
        return (Readiant.getInstance(Readiant.root)?.issuesState.content ?? new Set());
    }
    static get visual() {
        return Readiant.getInstance(Readiant.root)?.issuesState.visual ?? new Set();
    }
    static register() {
