...
class ReadiantElement extends HTMLElement {
    ...
    static dispatchEvent(type, detail) {
        if (readiantInstance !== null)
            readiantInstance.dispatchReadiantEvent(type, detail);
    }
}
