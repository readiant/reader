...
export class Audio {
    ...
    static fetchAudio(provider, page, time) {
        if (!Stream.hasMessageHandler(string.Audio))
            Stream.setMessageHandler(string.Audio, async (data) => this.onAudio(data));
        Stream.send({
            type: string.AudioRequest,
            pages: [page],
            provider,
            time,
        });
    ...
    static fetchSpeechMarks() {
        if (typeof this.provider === 'undefined')
            return;
        if (!Stream.hasMessageHandler(string.SpeechMark))
            Stream.setMessageHandler(string.SpeechMark, async (data) => this.onSpeechMark(data));
        for (const currentPage of Navigation.currentPages) {
            if (!Storage.hasSyntax(`${this.provider}__${String(currentPage.page)}`))
                Stream.send({
                    type: string.SpeechMarkRequest,
...
Audio.countdownButtons = document.getElementsByClassName('rdnt__countdown-button');
Audio.countdownCurrent = document.getElementsByClassName('rdnt__current-selection--countdown')[0];
Audio.countdownElement = document.getElementsByClassName('rdnt__countdown')[0];
Audio.countdownSettings = document.getElementsByClassName('rdnt__countdown-settings')[0];
Audio.lineHighlighterButtons = document.getElementsByClassName('rdnt__audio-line-highlighter-button');
Audio.lineHighlighterCurrent = document.getElementsByClassName('rdnt__current-selection--audio-line-highlighter')[0];
Audio.pauseButton = document.getElementsByClassName('rdnt__pause')[0];
Audio.playButton = document.getElementsByClassName('rdnt__play')[0];
Audio.playbackRateMinus = document.getElementsByClassName('rdnt__playback-rate--minus')[0];
Audio.playbackRatePlus = document.getElementsByClassName('rdnt__playback-rate--plus')[0];
Audio.playbackRateCurrent = document.getElementsByClassName('rdnt__current-selection--playback-rate')[0];
Audio.playbackRateInputs = document.getElementsByClassName('rdnt__playback-rate');
Audio.playbackRateSettings = document.getElementsByClassName('rdnt__playback-rate-settings')[0];
Audio.playbackRateTopSettings = document.getElementsByClassName('rdnt__menu__buttons-audio')[0];
Audio.progressElement = document.getElementsByClassName('rdnt__audio-progress')[0];
Audio.progressValue = document.getElementsByClassName('rdnt__audio-progress-value')[0];
Audio.providersList = document.getElementsByClassName('rdnt__providers-list')[0];
Audio.providersSettings = document.getElementsByClassName('rdnt__providers-settings')[0];
Audio.settingsButtons = document.getElementsByClassName('rdnt__bottom-bar-settings-button');
Audio.startButton = document.getElementsByClassName('rdnt__start')[0];
Audio.stopButton = document.getElementsByClassName('rdnt__stop')[0];
Audio.subtitlesButtons = document.getElementsByClassName('rdnt__subtitles-button');
Audio.subtitlesCurrent = document.getElementsByClassName('rdnt__current-selection--subtitles')[0];
Audio.subtitlesFontSizeSettings = document.getElementsByClassName('rdnt__subtitles-font-size-settings')[0];
Audio.voice = String(document.getElementsByClassName('rdnt__i18n')[0].getAttribute('data-voice'));
