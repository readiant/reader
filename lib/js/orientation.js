...
export class Orientation {
    ...
    static change(event) {
        ...
        if (typeof event === 'number') {
            ...
            if (event > 2)
                event = 2;
            const element = document.querySelector(`[data-orientation="${String(event)}"]`);
            if (element === null)
                return;
            element.click();
    ...
    static toggle() {
        ...
        const element = document.querySelector(`[data-orientation="${String(value)}"]`);
...
Orientation.buttons = document.getElementsByClassName('rdnt__orientation');
Orientation.current = document.getElementsByClassName('rdnt__current-selection--orientation')[0];
Orientation.title = document.getElementsByClassName('rdnt__orientation-settings--title')[0];
