...
export class Orientation {
    static get state() {
        ...
        return inst.orientationState;
    }
    static get _disableOrientationChange() {
        return this.state?.disableOrientationChange ?? false;
    }
    static set _disableOrientationChange(val) {
        if (this.state)
            this.state.disableOrientationChange = val;
    }
    static get _mode() {
        return this.state?.mode ?? OrientationMode.Landscape;
    }
    static set _mode(val) {
        if (this.state)
            this.state.mode = val;
    }
    static get buttons() {
