...
LineHighlighter.bottom = document.getElementsByClassName('rdnt__line-highlighter--bottom')[0];
LineHighlighter.buttons = document.getElementsByClassName('rdnt__line-highlight');
LineHighlighter.center = document.getElementsByClassName('rdnt__line-highlighter--center')[0];
LineHighlighter.colorButtons = document.getElementsByClassName('rdnt__line-highlighter-color');
LineHighlighter.currents = document.getElementsByClassName('rdnt__current-selection--line-highlighter');
LineHighlighter.off = String(document.getElementsByClassName('rdnt__i18n')[0].getAttribute('data-off'));
LineHighlighter.on = String(document.getElementsByClassName('rdnt__i18n')[0].getAttribute('data-on'));
LineHighlighter.ranges = document.getElementsByClassName('rdnt__line-highlighter-range');
LineHighlighter.settings = document.getElementsByClassName('rdnt__line-highlighter-settings');
LineHighlighter.top = document.getElementsByClassName('rdnt__line-highlighter--top')[0];
