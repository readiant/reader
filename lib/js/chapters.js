        ...
        for (let i = 0; i < this.chapters.length; i++) {
            ...
            if ('startPage' in chapter &&
                ...
                (typeof next === 'undefined' ||
                    ('startPage' in next && page < next.startPage))) {
                index = i;
                break;
            }
        }
...
Chapters.button = document.getElementsByClassName('rdnt__chapters-button')[0];
Chapters.closeButton = document.getElementsByClassName('rdnt__close-chapters')[0];
Chapters.list = document.getElementsByClassName('rdnt__chapters-list')[0];
