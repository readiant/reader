...
export class Annotations {
    ...
    static add(annotations) {
        for (const annotation of annotations) {
            ...
            if (importedAnnotations.every((importedAnnotation) => _a.isAnnotation(importedAnnotation)))
    ...
    static annotateStart(event) {
        ...
        const isLeft = [...document.elementsFromPoint(x, y)].some((element) => element.classList.contains('rdnt__markings--left'));
    ...
    static commentHandler(event) {
        ...
        const x = 'changedTouches' in event ? event.changedTouches[0].pageX : event.pageX;
        const y = 'changedTouches' in event ? event.changedTouches[0].pageY : event.pageY;
        const isLeft = [...document.elementsFromPoint(x, y)].some((element) => element.classList.contains('rdnt__comments--left'));
        const container = isLeft
            ? this.annotationLeftContainer
            : this.annotationRightContainer;
        const rect = container.getBoundingClientRect();
    ...
    static toggleComment(event) {
        ...
        const comments = document.getElementsByClassName('rdnt__comment-item');
...
Annotations.annotationSettings = document.getElementsByClassName('rdnt__annotation-settings')[0];
Annotations.markerSettings = document.getElementsByClassName('rdnt__marker-settings')[0];
Annotations.markerColorSettings = document.getElementsByClassName('rdnt__marker-color-settings')[0];
Annotations.annotationLeftContainer = document.getElementsByClassName('rdnt__annotations-surface--left')[0];
Annotations.annotationLeftCanvas = document.getElementsByClassName('rdnt__markings--left')[0];
Annotations.annotationLeftContext = _a.annotationLeftCanvas.getContext('2d');
Annotations.annotationLeftComments = document.getElementsByClassName('rdnt__comments--left')[0];
Annotations.annotationRightContainer = document.getElementsByClassName('rdnt__annotations-surface--right')[0];
Annotations.annotationRightCanvas = document.getElementsByClassName('rdnt__markings--right')[0];
Annotations.annotationRightContext = _a.annotationRightCanvas.getContext('2d');
Annotations.annotationRightComments = document.getElementsByClassName('rdnt__comments--right')[0];
Annotations.current = document.getElementsByClassName('rdnt__current-selection--annotations')[0];
Annotations.off = String(document.getElementsByClassName('rdnt__i18n')[0].getAttribute('data-off'));
Annotations.on = String(document.getElementsByClassName('rdnt__i18n')[0].getAttribute('data-on'));
Annotations.page = String(document.getElementsByClassName('rdnt__i18n')[0].getAttribute('data-page'));
Annotations.button = document.getElementsByClassName('rdnt__annotations-button')[0];
Annotations.closeButton = document.getElementsByClassName('rdnt__close-annotations')[0];
Annotations.showButton = document.getElementsByClassName('rdnt__show-annotations')[0];
Annotations.markerButton = document.getElementsByClassName('rdnt__marker')[0];
Annotations.commentButton = document.getElementsByClassName('rdnt__comment')[0];
Annotations.commentsList = document.getElementsByClassName('rdnt__comments-list')[0];
Annotations.undoButton = document.getElementsByClassName('rdnt__undo')[0];
Annotations.markerSizeRange = document.getElementsByClassName('rdnt__marker-size')[0];
Annotations.markerColorButtons = document.getElementsByClassName('rdnt__marker-color');
Annotations.markingsList = document.getElementsByClassName('rdnt__markings-list')[0];
Annotations.eraserButton = document.getElementsByClassName('rdnt__eraser')[0];
Annotations.editCommentTooltip = String(_a.commentButton.getAttribute('data-edit-comment'));
Annotations.removeCommentTooltip = String(_a.commentButton.getAttribute('data-remove-comment'));
