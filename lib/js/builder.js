...
import { Layout, SpeechMarkType, EffectiveConnectionType, } from './types.js';
...
export class Builder {
    static get animationLeft() {
        return document.getElementsByClassName('rdnt__animation--left')[0];
    }
    static get animationLeftFront() {
        return document.getElementsByClassName('rdnt__animation--left-front')[0];
    }
    static get animationLeftBack() {
        return document.getElementsByClassName('rdnt__animation--left-back')[0];
    }
    static get animationRight() {
        return document.getElementsByClassName('rdnt__animation--right')[0];
    }
    static get animationRightFront() {
        return document.getElementsByClassName('rdnt__animation--right-front')[0];
    }
    static get animationRightBack() {
        return document.getElementsByClassName('rdnt__animation--right-back')[0];
    }
    static get defs() {
        return document.getElementsByClassName('rdnt__defs')[0];
    }
    static get elems() {
        return document.getElementsByClassName('rdnt__elements')[0];
    }
    static get htmlLayer() {
        return document.getElementsByClassName('rdnt__layer--html')[0];
    }
    static get htmlTextLayer() {
        return document.getElementsByClassName('rdnt__text--html')[0];
    }
    static get htmlPage() {
        return document.getElementsByClassName('rdnt__html-page')[0];
    }
    static get htmlPageContent() {
        return document.getElementsByClassName('rdnt__html-page--content')[0];
    }
    static get layers() {
        return document.getElementsByClassName('rdnt__layers')[0];
    }
    static get left() {
        return document.getElementsByClassName('rdnt__page--left')[0];
    }
    static get leftLayer() {
        return document.getElementsByClassName('rdnt__layer--left')[0];
    }
    static get leftTextLayer() {
        return document.getElementsByClassName('rdnt__text--left')[0];
    }
    static get plainTextPage() {
        return document.getElementsByClassName('rdnt__plain-text-page')[0];
    }
    static get plainTextPageContent() {
        return document.getElementsByClassName('rdnt__plain-text-page__content')[0];
    }
    static get plainTextPageLines() {
        return document.getElementsByClassName('rdnt__plain-text-page__lines')[0];
    }
    static get progress() {
        return document.getElementsByClassName('rdnt__progress-value')[0];
    }
    static get right() {
        return document.getElementsByClassName('rdnt__page--right')[0];
    }
    static get rightLayer() {
        return document.getElementsByClassName('rdnt__layer--right')[0];
    }
    static get rightTextLayer() {
        return document.getElementsByClassName('rdnt__text--right')[0];
    }
    static get wordLabel() {
        return String(document.getElementsByClassName('rdnt__i18n')[0].getAttribute('data-word-label'));
    }
    static get viewport() {
        return document.getElementsByClassName('rdnt__viewport')[0];
    }
    ...
    static setDirection(direction) {
        if (direction === Direction.Rtl) {
            ...
            if (typeof this.htmlPage !== 'undefined')
