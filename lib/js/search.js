...
export class Search {
    ...
    static search() {
        ...
        if (query.length === 0) {
            ...
            if (!Stream.hasMessageHandler(string.SearchResult))
                Stream.setMessageHandler(string.SearchResult, (data) => {
                    this.onResult(data);
                });
            Stream.send({
                type: string.Search,
...
Search.button = document.getElementsByClassName('rdnt__search-button')[0];
Search.closeButton = document.getElementsByClassName('rdnt__close-search')[0];
Search.input = document.getElementsByClassName('rdnt__input')[0];
Search.nResults = String(document.getElementsByClassName('rdnt__i18n')[0].getAttribute('data-n-results'));
Search.noResults = String(document.getElementsByClassName('rdnt__i18n')[0].getAttribute('data-no-results'));
Search.oneResult = String(document.getElementsByClassName('rdnt__i18n')[0].getAttribute('data-one-result'));
Search.page = String(document.getElementsByClassName('rdnt__i18n')[0].getAttribute('data-page'));
Search.results = document.getElementsByClassName('rdnt__search-results')[0];
Search.summary = document.getElementsByClassName('rdnt__search-summary')[0];
