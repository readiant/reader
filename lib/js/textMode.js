...
export class TextMode {
    static get buttons() {
        return document.getElementsByClassName('rdnt__text-mode');
    }
    static get current() {
        return document.getElementsByClassName('rdnt__current-selection--text-mode')[0];
    }
    static get title() {
        return document.getElementsByClassName('rdnt__block-title--text-mode')[0];
    }
    static register() {
